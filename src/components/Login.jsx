    ...
    <div className="login">
      <div className="content">
        <div className="contentSignIn">
          ...
          <p className="continue">to continue to Gmail</p>
        </div>
        <div className="inputContent">
          <button className="next" onClick={handleSignIn}>
            Sign in
          </button>
      ...
      <div className="subtext">
        <div className="subtextOne">
          <p>English(United States)</p>
          <IconButton>
            <ArrowDropDownIcon />
          </IconButton>
        </div>
        <div className="subtextTwo">
          <p>
            <a
              rel="noreferrer"
              target="_blank"
              href="https://support.google.com/accounts?hl=en&visit_id=638242373436153524-51212104&rd=2&p=account_iph#topic=3382296"
            >
              Help
            </a>
          </p>
          ...
          <p>
            <a
              rel="noreferrer"
              target="_blank"
              href="https://policies.google.com/terms?gl=IN&hl=en-US"
            >
              Terms
            </a>
          </p>
